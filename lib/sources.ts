...
export type CcdyDigitalPaperConfig = {
  adapter: 'ccdy-digital-paper'
  apiUrl: string
  token: string
  maxItems?: number
}

export type ShxwcbHomeConfig = {
  adapter: 'shxwcb-home'
  apiUrl: string
  maxItems?: number
}

export type JinaMarkdownLinksConfig = {
  adapter: 'jina-markdown-links'
  proxyUrl: string
  sourceHost: string
  pathPrefix: string
  linkPattern?: string
...
const WEB_SOURCES: NewsSource[] = [
  ...
  },
  {
    ...
    scrapeConfig: { itemSelector: '.news-post-content a[href], .news-post-featured-content a[href]', titleSelector: '', linkSelector: '', maxItems: 10 },
  },
  {
    id: 'icom-news', name: 'ICOM', url: 'https://icom.museum/en/news/?pid=2',
    language: 'en', priority: 'P1', type: 'web',
    scrapeConfig: { itemSelector: 'a.news-abstract[href]', titleSelector: '', linkSelector: '', maxItems: 10 },
  },
  {
    id: 'museums-association-news', name: 'Museums Association', url: 'https://www.museumsassociation.org/museums-journal/news/',
    language: 'en', priority: 'P1', type: 'web',
    scrapeConfig: { itemSelector: '.card-journal', titleSelector: '.card-journal__title', linkSelector: 'a[href][aria-labelledby]', maxItems: 10 },
  },
  ...
  // --- 文创/文博 ---
  {
    ...
    scrapeConfig: {
      adapter: 'ccdy-digital-paper',
      apiUrl: 'https://zcy.ccmapp.cn/apis/resource/digitalboardnew/get',
  ...
  {
    id: 'ihchina', name: '中国非物质文化遗产网', url: 'https://www.ihchina.cn/news',
    language: 'zh', priority: 'P1', type: 'web', automationEnabled: true,
    scrapeConfig: { itemSelector: '.h16 a[href*="_details/"][title]', titleSelector: '', linkSelector: '', linkPrefix: 'https://www.ihchina.cn', maxItems: 10 },
  },
  ...
  // 艺恩网已转型为数据/AI 产品站，不再提供持续更新的影视资讯列表，生产库中的旧记录应清退。
  // 灯塔 — DNS不可达，已移除
  // 猫眼 — 数据仪表板非新闻源，已移除
  {
  ...
  },
  {
    ...
    scrapeConfig: {
      adapter: 'shxwcb-home',
      apiUrl: 'https://api.zhoudaosh.com/apiv5.php?a=Site',
      maxItems: 10,
    },
  },
  {
    id: 'zjol', name: '浙江日报/潮新闻', url: 'https://zjnews.zjol.com.cn/',
    language: 'zh', priority: 'P2', type: 'web',
    scrapeConfig: { itemSelector: 'a[href*="/202"][href*=".shtml"]', titleSelector: '', linkSelector: '', linkPrefix: 'https://zjnews.zjol.com.cn', maxItems: 10 },
  },
  {
    id: 'hubeidaily', name: '湖北日报', url: 'https://www.hubeidaily.net',
    language: 'zh', priority: 'P2', type: 'web',
    scrapeConfig: { itemSelector: 'a[href*="/GroupDynamics/"][href$=".html"]', titleSelector: '', linkSelector: '', linkPrefix: 'https://www.hubeidaily.net', maxItems: 8 },
  },
  {
  ...
  },
  {
    ...
    language: 'zh', priority: 'P2', type: 'web',
    aliases: ['红星新闻(成都)'],
    scrapeConfig: { adapter: 'sitemap-article-links', sitemapUrl: 'https://static.cdsb.com/cdsbmap.xml', linkPattern: '^https://static\\.cdsb\\.com/micropub/Articles/\\d{6}/[^/]+\\.html$', maxItems: 10 },
  },
  {
...
const GOV_SOURCES: NewsSource[] = [
  ...
  { id: 'gov-cn', name: '国务院', aliases: ['国务院政策文件库'], url: 'https://www.gov.cn/zhengce/zhengceku/bmwj/home.htm', language: 'zh', priority: 'P1', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="content_"]', titleSelector: '', linkSelector: '', linkPrefix: 'https://www.gov.cn/zhengce/zhengceku/bmwj/', maxItems: 5 } },
...
{ id: 'zj-wlt', name: '浙江省文旅厅', aliases: ['浙江省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/zj/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'ln-wlt', name: '辽宁省文旅厅', aliases: ['辽宁省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/ln/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'jl-wlt', name: '吉林省文旅厅', aliases: ['吉林省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/jl/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'hunan-wlt', name: '湖南省文旅厅', aliases: ['湖南省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/hn_7731/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'gd-wlt', name: '广东省文旅厅', aliases: ['广东省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/gd/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'gx-wlt', name: '广西文旅厅', aliases: ['广西壮族自治区文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/gx/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'gz-wlt', name: '贵州省文旅厅', aliases: ['贵州省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/gz/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'yn-wlt', name: '云南省文旅厅', aliases: ['云南省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/yn/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'sn-wlt', name: '陕西省文旅厅', aliases: ['陕西省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/sx_7740/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'gs-wlt', name: '甘肃省文旅厅', aliases: ['甘肃省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/gs/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'qh-wlt', name: '青海省文旅厅', aliases: ['青海省文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/qh/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'nx-wlt', name: '宁夏文旅厅', aliases: ['宁夏回族自治区文化和旅游厅'], url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/nx/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
]
...
export function findSourceConfiguration(url: string, name = ''): NewsSource | undefined {
  ...
  return ALL_SOURCES.find((source) => [source.name, ...(source.aliases ?? [])].some((sourceName) => {
    const candidateName = normalizeSourceName(sourceName)
