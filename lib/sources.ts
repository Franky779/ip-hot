...
const GOV_SOURCES: NewsSource[] = [
  ...
  { id: 'ln-wlt', name: '辽宁省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/ln/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'jl-wlt', name: '吉林省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/jl/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'js-wlt', name: '江苏省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/js/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'ah-wlt', name: '安徽省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/ah/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  ...
  { id: 'jx-wlt', name: '江西省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/jx/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'sd-wlt', name: '山东省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/sd/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
  { id: 'henan-wlt', name: '河南省文旅厅', url: 'https://www.mct.gov.cn/whzx/qgwhxxlb/hn/', language: 'zh', priority: 'P2', type: 'gov', scrapeConfig: { itemSelector: 'a[href*="/202"][href*="t202"]', titleSelector: '', linkSelector: '', maxItems: 5 } },
