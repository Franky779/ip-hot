...
import { factoryFolderName, factoryImagePath, getFactoryImageDir, uniqueFactoryFilename } from '@/lib/factory-admin'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    for (const file of files) {
      ...
      saved.push({ local: factoryImagePath(folder, filename) })
    }
