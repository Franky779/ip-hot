...
import { licenseeFolderName, licenseeImagePath, getLicenseeImageDir, uniqueLicenseeFilename } from '@/lib/licensee-admin'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    for (const file of files) {
      ...
      saved.push({ local: licenseeImagePath(folder, filename) })
    }
