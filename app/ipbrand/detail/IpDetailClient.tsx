...
import { mergeIpRecords, EMPTY_ADMIN, type IpBrandEdit, type IpCustomCard, type IpRecord, type IpImage, type IpCase } from '@/lib/ipbrand-types'
    ...
    body = (
      <>
            ...
            <div className="ipd-meta-edit">
              ...
              <div className="ipd-meta-edit-grid">
                ...
                <div className="ipd-meta-edit-item">
                  ...
                  <div className="ipd-meta-edit-ctrl">
                    <input className="ipd-edit-input" value={draft.category || ''} onChange={e => patch({ category: e.target.value })} placeholder="如：卡通动漫" />
                    <button className="ipd-mini-btn" onClick={() => patch({ category: '' })}>清除</button>
                  </div>
                </div>
                <div className="ipd-meta-edit-item">
                  <div className="ipd-meta-edit-label">出品国家/地区</div>
                  <div className="ipd-meta-edit-ctrl">
                    <input className="ipd-edit-input" value={draft.place_origin || ''} onChange={e => patch({ place_origin: e.target.value })} placeholder="如：日本" />
                    <button className="ipd-mini-btn" onClick={() => patch({ place_origin: '' })}>清除</button>
                  </div>
                </div>
                <div className="ipd-meta-edit-item">
                ...
                {(Object.keys(META_ARR_LABEL) as MetaArrKey[]).map(k => (
        ...
        <div className="ipd-section">
          ...
          <div className="ipd-edit-hint">相关新闻来自快讯自动匹配，仅标题可改。</div>
          {feedNews.length > 0 ? (
